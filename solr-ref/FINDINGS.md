...
behavior, deliberate differences, and permanent unsupported boundaries are described in
...
finding 76 and the former scope record had been relying on: that the module calls the `/terms`
handler. It does not. The client-path evidence follows.
